...
public class Title implements Node, Visitable {
	...
	public Title(ArrayList<Node> nodes, Map attributesMap, String s) {
...
//	public Title(ArrayList<Node> nodes, Map attributesMap) {
//		this.listOfNodes = nodes;
//		this.hashMap = attributesMap;
//		// convert the HashMap to TreeMap for sorted order:
//		this.map = new TreeMap<String, String>(hashMap);
